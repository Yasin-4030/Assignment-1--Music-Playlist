class Song:  # class Song is a node within a linked list called Playlist

  def __init__(self, title):
      self.__title = title   #the data part of our node 'Song'
      self.__next_song = None  #the address part for our node 'Song'
  ...
  def __repr__(self):
    return f'Next Song Title {self.__title}'